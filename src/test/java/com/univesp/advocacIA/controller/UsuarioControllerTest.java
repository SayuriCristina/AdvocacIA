...
class UsuarioControllerTest {
    ...
    void start() {
        ...
        usuarioService.cadastrarUsuario(TestBuilder.criarUsuario(null, "Root", ADMIN, SENHA, 0));
    }
    ...
    void deveCadastrarUsuario() {
        ...
        // Given
        Usuario usuario = TestBuilder.criarUsuario(null, "Paulo Antunes", "paulo_antunes@email.com.br", "12345678", 0);
    ...
    void naoDeveDuplicarUsuario() {
        ...
        // Given
        Usuario usuario = TestBuilder.criarUsuario(null, "Maria da Silva", "maria_silva@email.com.br", "12345678", 0);
    ...
    void deveAtualizarUmUsuario() {
        ...
        // Given
        Usuario usuario = TestBuilder.criarUsuario(null, "Juliana Andrews", "ju_andrews@email.com.br", "12345678", 0);
        ...
        Usuario usuarioUpdate = TestBuilder.criarUsuario(cadastrado.get().getId(), "Juliana Ramos",
                "ju_ramos@email.com.br", "12345678", 5);
